...
module.exports = {
    ...
    execute: async (client, message, args) => {
        ...
        if (args.length < 2) {
            return message.reply('Para adicionar um emoji, utilize o comando `!addemoji <nome> <url>`.');
        }
        ...
        if (!emojiUrl.startsWith('http')) {
            return message.reply('URL inválida! Certifique-se de que a URL comece com `http`.');
        }
        ...
        try {
            ...
            if (imageSize > 256000) {
                return message.reply('O tamanho do emoji não pode ser maior que 256KB.');
            }
            ...
            return message.reply('Ocorreu um erro ao adicionar o emoji. Verifique o console para mais detalhes.');
        }
    },
};